                    ...
                    <div class="col-md-4 col-12">
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" id="nik_ibu" name="nik_ibu"
                                placeholder="nik ibu" value="{{ old('nik_ibu', $studentparent->nik_ibu) }}" />
                        </div>
                    </div>
                </div>
            ...
            <fieldset>
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" type="text" id="alamat_wali" name="alamat_wali"
                        placeholder="alamat wali" value="{{ old('alamat_wali', $studentparent->alamat_wali) }}" />
                </div>
