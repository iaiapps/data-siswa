...
@section('content')
    ...
    {{-- @dd(Auth::group()->hasRole('admin')) --}}
    <a href="{{ route('group.create') }}" class="btn btn-primary mb-3">Tambah Kelas</a>
    {{-- <a href="{{ route('group.create') }}" class="btn btn-primary mb-3">tambah data guru</a> --}}
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('showstudentgroup', ['id' => $group->id]) }}"
                                    ...
                                    siswa</a>
                                <a href="{{ route('addstudentgroup') }}" class="btn btn-warning btn-sm">edit
                                    siswa</a>
                            </td>
                            <td>
